...
ReferenceImages = ["ArrowL.jpg","ArrowR.jpg","ArrowT.jpg"]
ReferenceTitles = ["Turn Left 90","Turn Right 90","Turn Around"]
...
imageGo =cv2.imread("Go.jpg", cv2.COLOR_BGR2GRAY)
imageGoresize = cv2.resize(imageGo,(w/2,h/2),interpolation = cv2.INTER_AREA)
cv2.imshow("Go",imageGoresize);
